...
/**
 * Servlet implementation class ServletActivityGetByUserAndState
 */
@WebServlet("/ServletActivityGetByUserAndState")
public class ServletActivityGetByUserAndState extends HttpServlet {
	 ...
	 */
	public ServletActivityGetByUserAndState() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		iEjbActivity.getByIdUserAndState(Integer.parseInt(request.getSession().getAttribute("idUser").toString()),
